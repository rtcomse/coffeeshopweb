...
public class UserDetailsAccountController {
	...
	public List<String> findCurrentUserUsername () {
		...
		if ( ( authentication == null ) || !( authentication.isAuthenticated() ) ) {
			...
			LOGGER.error( "Authentication object is either null or not authenticated: {}", authentication ) ;
		...
		if ( !( principal instanceof UserDetails ) ) {
			...
			LOGGER.error( "Principal object is not an instance of UserDetails: {}", principal ) ;
			LOGGER.debug( "EXIT: findCurrentUserUsername ()" ) ;
